                                       ...
                                       if(val.images){
                                           ...
                                           if($.isArray(val.images) && val.images.length >0){
                                               $.each(val.images, function(index, value){
                                                   $('.imagesWrapper>td>div').append('<a target="_blank" href="'+value+'"><img src="'+value+'" class = "stepScreenShot"></a>');
                                               });
                                           }
                                           else{
                                               $('.imagesWrapper>td>div').append('<a target="_blank" href="'+val.images+'"><img src="'+val.images+'" class = "stepScreenShot"></a>');
                                           }
                                       }
                                   }
