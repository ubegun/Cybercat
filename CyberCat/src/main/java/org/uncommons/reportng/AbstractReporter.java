...
public abstract class AbstractReporter implements IReporter
{
    ...
    protected void copyBinary(File outputDirectory,
                                         String resourceName,
                                         String targetFileName) throws IOException
    {
        String resourcePath = classpathPrefix + resourceName;
        Files.copy(getClass().getClassLoader().getResourceAsStream(resourcePath),Paths.get(outputDirectory.toString(),targetFileName), StandardCopyOption.REPLACE_EXISTING);
    }
}
