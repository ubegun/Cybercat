...
public abstract class AbstractReporter implements IReporter {
  ...
  protected void copyBinary(File outputDirectory, String resourceName, String targetFileName) throws IOException {
    String resourcePath = classpathPrefix + resourceName;
    Files.copy(getClass().getClassLoader().getResourceAsStream(resourcePath), Paths.get(outputDirectory.toString(), targetFileName),
   ...
   */
  protected static void copyFile(File outputDirectory, File sourceFile, String targetFileName) throws IOException {
   ...
   */
  protected static void copyStream(File outputDirectory, InputStream stream, String targetFileName) throws IOException {
  ...
  /**
   * Deletes any empty directories under the output directory. These directories are created by TestNG for its own
   * reports regardless of whether those reports are generated. If you are using the default TestNG reports as well as
   * ReportNG, these directories will not be empty and will be retained. Otherwise they will be removed.
   * 
   * @param outputDirectory
   *          The directory to search for empty directories.
   */
  protected static void removeEmptyDirectories(File outputDirectory) {
