...
public class PasswordField extends Button {

    private final static Logger log = Logger.getLogger(PasswordField.class);

    public PasswordField(String name, PathType type, String path) {
    ...
    public void typeText(String text) throws PageObjectException {
        if (super.getElement() != null) {
            ...
            log.info(getName() + " password field has been filled." );
        } else {
