...
public class RemoteRoleActors  implements java.io.Serializable {
    private org.cybercat.automation.addons.jira.soap.RemoteProjectRole projectRole;

    private org.cybercat.automation.addons.jira.soap.RemoteRoleActor[] roleActors;

    private org.cybercat.automation.addons.jira.soap.RemoteUser[] users;

    public RemoteRoleActors() {
    }

    public RemoteRoleActors(
           org.cybercat.automation.addons.jira.soap.RemoteProjectRole projectRole,
           org.cybercat.automation.addons.jira.soap.RemoteRoleActor[] roleActors,
           org.cybercat.automation.addons.jira.soap.RemoteUser[] users) {
     ...
     * @return projectRole
     */
    public org.cybercat.automation.addons.jira.soap.RemoteProjectRole getProjectRole() {
        return projectRole;
    }
     ...
     * @param projectRole
     */
    public void setProjectRole(org.cybercat.automation.addons.jira.soap.RemoteProjectRole projectRole) {
        this.projectRole = projectRole;
    }
     ...
     * @return roleActors
     */
    public org.cybercat.automation.addons.jira.soap.RemoteRoleActor[] getRoleActors() {
        return roleActors;
    }
     ...
     * @param roleActors
     */
    public void setRoleActors(org.cybercat.automation.addons.jira.soap.RemoteRoleActor[] roleActors) {
        this.roleActors = roleActors;
    }
     ...
     * @return users
     */
    public org.cybercat.automation.addons.jira.soap.RemoteUser[] getUsers() {
        return users;
    }
     ...
     * @param users
     */
    public void setUsers(org.cybercat.automation.addons.jira.soap.RemoteUser[] users) {
        this.users = users;
    }
