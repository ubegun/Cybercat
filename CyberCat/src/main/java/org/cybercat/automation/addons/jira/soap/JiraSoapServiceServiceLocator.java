...
public class JiraSoapServiceServiceLocator extends org.apache.axis.client.Service implements org.cybercat.automation.addons.jira.soap.JiraSoapServiceService {

    public JiraSoapServiceServiceLocator(String jirasoapserviceV2_address) {
        this.JirasoapserviceV2_address = JirasoapserviceV2_address;
        JirasoapserviceV2SoapBindingStub.sutupSoapOperation(JirasoapserviceV2_address); 
    }
    ...
    private java.lang.String JirasoapserviceV2_address;
    ...
    public javax.xml.namespace.QName getServiceName() {
        return JirasoapserviceV2SoapBindingStub.getJiraQName("JiraSoapServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(JirasoapserviceV2SoapBindingStub.getJiraQName("jirasoapservice-v2"));
        }
