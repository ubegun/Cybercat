...
public class RemotePermissionMapping  implements java.io.Serializable {
    private org.cybercat.automation.addons.jira.soap.RemotePermission permission;

    private org.cybercat.automation.addons.jira.soap.RemoteEntity[] remoteEntities;

    public RemotePermissionMapping() {
    }

    public RemotePermissionMapping(
           org.cybercat.automation.addons.jira.soap.RemotePermission permission,
           org.cybercat.automation.addons.jira.soap.RemoteEntity[] remoteEntities) {
     ...
     * @return permission
     */
    public org.cybercat.automation.addons.jira.soap.RemotePermission getPermission() {
        return permission;
    }
     ...
     * @param permission
     */
    public void setPermission(org.cybercat.automation.addons.jira.soap.RemotePermission permission) {
        this.permission = permission;
    }
     ...
     */
    public org.cybercat.automation.addons.jira.soap.RemoteEntity[] getRemoteEntities() {
        return remoteEntities;
    }
     ...
     */
    public void setRemoteEntities(org.cybercat.automation.addons.jira.soap.RemoteEntity[] remoteEntities) {
        this.remoteEntities = remoteEntities;
    }
